...
function update_notifier_menu() {
	...
	$theme_version = $my_theme->get('Version'); // Get theme data from style.css (current version is what we want)

	if(version_compare($theme_version, $xml->latest) == -1) {
		add_dashboard_page( $theme_name . 'Theme Updates', $theme_name . '<span class="update-plugins count-1"><span class="update-count">New Updates</span></span>', 'administrator', 'minimable-premium-updates', 'update_notifier');
	}
...
function update_notifier() {
	...
	<div class="wrap">
        ...
        <div id="instructions" style="max-width: 800px;">
            ...
            <p>To update the Theme, download it from your page account.</p>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://abito.fedeweb.net/notifier.xml';
